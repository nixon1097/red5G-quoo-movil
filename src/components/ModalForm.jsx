...
const ModalForm = ({ contenido }) => {
  const info = contenido;
  // contenido.tarjetaSeleccionada;

  return (
    <>
      <section className="modal fixed animate-fade animate-delay-100 animate-ease-in  transform transition-transform duration-300 ease-in-out bg-slate-500/70  z-50  w-screen  h-full top-0 left-0 flex items-center justify-center overflow-y-hiddend">
        <article
